...
func Layout(title string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 2, " | Wafflerace</title><link rel=\"icon\" href=\"data:image/svg+xml,<svg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 100 100%22><text y=%22.9em%22 font-size=%2290%22>🧇</text></svg>\"><link rel=\"stylesheet\" href=\"/static/css/app.css\"><script>\n\t\t\t\tconst params = new URLSearchParams(window.location.search);\n\t\t\t\tconst theme = params.get('theme') || localStorage.getItem('wafflerace_theme') || 'default';\n\t\t\t\tdocument.documentElement.setAttribute('data-theme', theme);\n\t\t\t</script></head><body class=\"bg-base-200 min-h-screen\"><div class=\"navbar bg-base-100 shadow-sm\"><div class=\"flex-1\"><a href=\"/\" class=\"btn btn-ghost text-xl\"><picture><source srcset=\"/assets/logo.webp\" type=\"image/webp\"> <img src=\"/assets/logo.png\" alt=\"Wafflerace\" class=\"h-8 max-w-[220px] mr-1 object-contain\"></picture></a></div><div class=\"flex-none\"><a href=\"/history\" class=\"btn btn-ghost\">History</a></div></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
